...
- Official schedule entries are decoded individually from escaped or reordered EventMatch JSON; malformed entries are skipped, while valid team-pair/date/time matches retain their official game IDs. Unresolved opponents and impossible series scores are kept upcoming instead of being treated as completed results.
